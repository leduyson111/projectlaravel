    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="banner_slider fullwidht  mb-35">
                <img src="{{url('fe-assets\assets\img\banner\bannner10.jpg')}}" alt="">
            </div> 
            <!--banner slider start-->
        </div>
    </div>       
            ...
            <div class="tab-pane fade show active" id="large" role="tabpanel">
                ...
                @endforeach
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="single_product">
                            <div class="product_thumb">
                               <a href="single-product.html"><img src="{{url('fe-assets\assets\img\product\product5.jpg')}}" alt=""></a> 
                               <div class="img_icone">
                                   <img src="{{url('fe-assets\assets\img\cart\span-new.png')}}" alt="">
                               </div>
                               <div class="product_action">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="single_product">
                            <div class="product_thumb">
                               <a href="single-product.html"><img src="{{url('fe-assets\assets\img\product\product6.jpg')}}" alt=""></a> 
                               <div class="hot_img">
                                   <img src="{{url('fe-assets\assets\img\cart\span-hot.png')}}" alt="">
                               </div>
                               <div class="product_action">
