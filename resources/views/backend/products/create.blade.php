...
@section('content')
    ...
    <form name="product" action="{{url("/backend/product/store")}}" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="number" name="product_quantity" style="width: 250px" value="{{old('product_quantity',"")}}" class="form-control" id="product_quantity">
        </div>

        <div class="form-group">
            <label for="product_price">Giá sản phẩm:</label>
            <input type="text" name="product_price" style="width: 250px" value="{{old('product_price',"")}}" class="form-control" id="product_price">
        </div>
