                                ...
                                <ul>
                                    <li class="languages"><a href="#"><img src="assets\img\logo\fontlogo.jpg" alt=""> English <i class="fa fa-angle-down"></i></a>
                                        <ul class="dropdown_languages">
                                            <li><a href="#"><img src="{{url('fe-assets\assets\img\logo\fontlogo.jpg')}}" alt=""> English</a></li>
                                            <li><a href="#"><img src="{{url("fe-assets\assets\img\logo\fontlogo2.jpg")}}" alt=""> French </a></li>
                                        </ul>
                                    </li>
                            ...
                            <div class="header_right_info">
                                ...
                                <div class="shopping_cart">
                                    ...
                                    <div class="mini_cart">
                                        <div class="cart_item">
                                            <div class="cart_img">
                                                <a href="#"><img src="{{url("fe-assets/assets/img/cart/cart.jpg")}}" alt=""></a>
                                            </div>
                                            <div class="cart_info">
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="#">women</a>
                                                <div>
                                                    ...
                                                    <div>
                                                        <div>
                                                            <a href="#"><img src="{{url("\\fe-assets\assets\img\banner\banner1.jpg")}}" alt=""></a>
                                                        </div>
                                                        <div>
                                                            <a href="#"><img src="{{url("\\fe-assets\assets\img\banner\banner2.jpg")}}" alt=""></a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </li>
                                            <li><a href="#">men</a>
                                                <div>
                                                    <div>
                                                        ...
                                                        <div>
                                                            <a href="#"><img src="{{url("\\fe-assets\assets\img\banner\banner3.jpg")}}" alt=""></a>
                                                        </div>
                                                    </div>
                    ...
                    <div class="col-12">
                        <div class="banner_slider slider_two">
                            <div class="slider_active owl-carousel">
                                <div class="single_slider" style="background-image: url({{url("fe-assets/assets/img/slider/slider_2.png")}})">
                                ...
                                <div class="single_slider" style="background-image: url({{url("fe-assets/assets/img/slider/slide_4.png")}})">
                                    <div class="slider_content">
                                        <div class="slider_content_inner">
                                            <h1>fashion for you</h1>
                                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. <br> Cumque eligendi quia, ratione porro, nemo non.</p>
                                ...
                                <div class="single_slider" style="background-image: url({{url("fe-assets/assets/img/slider/slider_3.png")}})">
                                    <div class="slider_content">
                                        <div class="slider_content_inner">
                                            <h1>fashion for you</h1>
                                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. <br> Cumque eligendi quia, ratione porro, nemo non.</p>
                    ...
                    <div class="row">
                        <div class="single_p_active owl-carousel">
                            <div class="col-lg-3">
                                <div class="single_product">
                                    <div class="product_thumb">
                                        <a href="single-product.html"><img src="{{url("fe-assets/assets/img/product/product1.jpg")}}" alt=""></a>
                                        <div class="img_icone">
                                            <img src="{{url("fe-asset\ssets\img\cart\span-new.png")}}a" alt="">
                                        </div>
                            ...
                            <div class="col-lg-3">
                                <div class="single_product">
                                    <div class="product_thumb">
                                        <a href="single-product.html"><img src="{{url("fe-assets/assets/img/product/product2.jpg")}}" alt=""></a>
                                        <div class="hot_img">
                            ...
                            <div class="col-lg-3">
                                <div class="single_product">
                                    <div class="product_thumb">
                                        <a href="single-product.html"><img src="{{url("fe-assets/assets/img/product/product3.jpg")}}" alt=""></a>
                                        <div class="img_icone">
                            ...
                            <div class="col-lg-3">
                                <div class="single_product">
                                    <div class="product_thumb">
                                        <a href="single-product.html"><img src="{{url("fe-assets/assets/img/product/product4.jpg")}}" alt=""></a>
                                        <div class="hot_img">
                                            <img src="assets\img\cart\span-hot.png" alt="">
                                        </div>
                                        <div class="product_action">
                    ...
                    <div class="row">
                        <div class="single_p_active owl-carousel">
                            <div class="col-lg-3">
                                <div class="single_product">
                                    <div class="product_thumb">
                                        <a href="single-product.html"><img src="{{url("fe-assets\assets\img\product\product7.jpg")}}" alt=""></a>
                                        <div class="img_icone">
                                            <img src="assets\img\cart\span-new.png" alt="">
                                        </div>
                                        <div class="product_action">
                            ...
                            <div class="col-lg-3">
                                <div class="single_product">
                                    <div class="product_thumb">
                                        <a href="single-product.html"><img src="{{url("fe-assets\assets\img\product\product8.jpg")}}" alt=""></a>
                                        <div class="hot_img">
                                            <img src="assets\img\cart\span-hot.png" alt="">
                                        </div>
                                        <div class="product_action">
                            ...
                            <div class="col-lg-3">
                                <div class="single_product">
                                    <div class="product_thumb">
                                        <a href="single-product.html"><img src="{{url("fe-assets\assets\img\product\product9.jpg")}}" alt=""></a>
                                        <div class="img_icone">
                                            <img src="assets\img\cart\span-new.png" alt="">
                                        </div>
                                        <div class="product_action">
                ...
                <div class="blog_area blog_two">
                    <div class="row">
                        <div class="col-lg-4 col-md-6">
                            <div class="single_blog">
                                <div class="blog_thumb">
                                    <a href="blog-details.html"><img src="{{url("fe-assets\assets\img\blog\blog3.jpg")}}" alt=""></a>
                                </div>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="single_blog">
                                <div class="blog_thumb">
                                    <a href="blog-details.html"><img src="{{url("fe-assets\assets\img\blog\blog4.jpg")}}" alt=""></a>
                                </div>
                                <div class="blog_content">
                                    <div class="blog_post">
                                        <ul>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="single_blog">
                                <div class="blog_thumb">
                                    <a href="blog-details.html"><img src="{{url("fe-assets\assets\img\blog\blog1.jpg")}}" alt=""></a>
                                </div>
                                <div class="blog_content">
                                    <div class="blog_post">
                                        <ul>
